   ...
   economics: {
      ...
      icon: (
         ...
         >
            ...
            <path d="M12 6C9.79 6 8 7.79 8 10S9.79 14 12 14 16 12.21 16 10 14.21 6 12 6ZM12 12C10.9 12 10 11.1 10 10S10.9 8 12 8 14 8.9 14 10 13.1 12 12 12Z" />
         </svg>
      ),
   },
   philanthropy: {
   ...
   innovation: {
      ...
      icon: (
         <svg
            ...
            fill="currentColor"
         >
            <path d="M9 11H15L13.5 7.5L9 11Z" />
            <path d="M12 2L13.09 8.26L22 9L13.09 9.74L12 16L10.91 9.74L2 9L10.91 8.26L12 2Z" />
            <path d="M19 15L20.09 18.26L23 19L20.09 19.74L19 23L17.91 19.74L15 19L17.91 18.26L19 15Z" />
         </svg>
      ),
   ...
   return (
      <div className={ny("not-prose flex flex-row gap-2", className)}>
         {technologies.map((tech) => {
            ...
            if (!techComponent) {
               console.warn(`Technology "${tech}" not found in techComponents`)
               return null
            }
            return (
               <Tooltip key={tech}>
                  <TooltipTrigger>{techComponent.icon}</TooltipTrigger>
                  <TooltipContent>
                     <p>{techComponent.name}</p>
                  </TooltipContent>
               </Tooltip>
            )
         })}
